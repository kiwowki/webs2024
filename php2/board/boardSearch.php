<?php
    ...
    $searchKeyword = $_GET['searchKeyword'];    // 나중엔 에스풀 어쩌구 방식 씀
...
<?php
    ...
    if($page != 1){
        ...
        echo "<li class='next'><a href='boardSearch.php?page={$prevPage}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>이전</a></li>";
    }
