    ...
    <main id="main" role="main">
        <div class="intro_inner bmStyle container">
            <div class="intro_img main">
                <img srcset="../assets/img/intro02.jpg 1x, ../assets/img/intro02@2x.jpg 2x, ../assets/img/intro02@3x.jpg 3x"
                    alt="소개 이미지">
            </div>
                ...
                <form action="joinResult.php" name="joinResult" method="post" onsubmit="return joinChecks();">
                    <fieldset>
                        ...
                        <div class="join">
                            ...
                            <input type="text" id="youName" name="youName" placeholder="이름을 적어주세요!" class="input_style">
                        ...
                        <div class="join">
                            ...
                            <div class="check">
                                <input type="text" id="youEmail" name="youEmail" placeholder="이메일을 적어주세요!"
                                    class="input_style">
    ...
    <script>
        ...
        function joinChecks() {
            ...
            if ($("#youPass").val() == '') {
                ...
                let getYouPassNum = getYouPass.search(/[0-9]/g);   // g= 중복, i= 소대문자 비구분
